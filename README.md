...
- 💼 [LinkedIn](https://linkedin.com/in/gustavo-alvesx) | 🌐 [Portfólio](https://portifolio-gustavo-alves.vercel.app/)

---

### 🏆 Conquistas & Medalhas
* **SP Skills (Cloud Computing - AWS):** 10° lugar no Estado de São Paulo.
* **Prêmio de Inovação (IV Feira de Ciência):** 1° lugar com o projeto EcoCity.
* **Huawei ICT Competition:** Participante da fase Nacional (Cloud Track).
...
- 🎓 **AWS Academy Graduate:** Cloud Architecting / Operations / Foundations.
- 🤖 **Microsoft AI-900:** Implantação de IA em Nuvem.
